...
//'Hakeem Olajuwon'. If your name does happen to be Hakeem Olajuwon, 
...
//The param value passed in will be added in the unit test. If the param value is 'green' 
//set colorResponse variable to 'Green is okay'. If the param value is 'red' set reponse 
//variable to 'I heart red'. Otherwise set the colorResponse variable to 
//'What is your favorite color?'. Make sure to return the colorResponse variable 
...
// #9 Create a function called 'sum' that takes in one parameter and returns 
// the sum of that parameter added it itself.
